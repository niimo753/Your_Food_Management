...
from scripts import functions as ft
from scripts import interface as itf
...
#background img
img = itf.get_img_as_base64("images/Picture2.png")
page_bg_img = f"""
<style>
...
itf.local_css("styles/style.css")
...
if selected == "About Us":
    ...
    with col1_2:
        st.image("images/duong_pic.jpg")
        st.image("images/ngoc_pic.jpg")
        st.image("images/loc_pic.jpg")
    with col1_3:
        st.image("images/ha_pic.jpg")
        st.image("images/thanh_pic.jpg")
        st.image("images/linh_pic.jpg")
    ...
    with col0_1:
        pass
    with col0_2:
        st.image("images/Picture1.png", width=315)
    with col0_1:
        pass
    with col0_1:
        pass
    ...
    if calBMI:
        with st.spinner("Calculating"):
            ...
            bmi_range = pd.read_csv("data/bmi.csv")
    ...
    if st.button('Calculating Body fat percentage '):
        with st.spinner("Calculating"):
            ...
            df = pd.read_csv("data/body-fat-healthy-range.csv")
            st.dataframe(df)
    ...
    def suggest_recipes(diet, n, course, skill, ingred):
        ...
        df = pd.read_csv('data/clean_recipe2_5.csv',
